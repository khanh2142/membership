  ...
  <>
    <Container>
      <Grid fluid>
        ...
        <div className="member__navbar">
          <div className="member__navbar-link active">Hội viên</div>
          <div className="member__navbar-link">Điểm</div>
          <div className="member__navbar-link">Xét hạng</div>
          <div className="member__navbar-link">Ưu đãi</div>
          <div className="member__navbar-link">Lượt dịch vụ</div>
          <div className="member__navbar-link">Đại lý truy vấn</div>
        </div>
